...
const DECKS = {
 "ipc-conceptos": {
  "name": "Pentsamendu kritikoa · Oinarrizko kontzeptuak",
  "subject": "ipc",
  "cards": [
   [
    "💬",
    "Iritzia",
    "Norbaitek zerbaiti buruz pentsatzen duena. Gehiago balio du arrazoietan oinarritzen denean eta ez soilik gustuetan."
   ],
   [
    "🧩",
    "Argudioa",
    "Arrazoiekin (premisak) defendatutako baieztapena (ondorioa)."
   ],
   [
    "❓",
    "Galdera",
    "Pentsamenduaren tresna: ikerketa ireki egiten du, itxi beharrean."
   ],
   [
    "🗣️",
    "Eztabaida",
    "Jarrerak argudioekin aurrez aurre jartzea ideia bat defendatzeko."
   ],
   [
    "🤝",
    "Elkarrizketa",
    "Elkarrekin pentsatzea egiara hurbiltzeko, ez «irabazteko»."
   ],
   [
    "🔍",
    "Pentsamendu kritikoa",
    "Ideiak (norberarenak eta besterenak) onartu aurretik aztertzea, arrazoiak eta frogak bilatuz."
   ],
   [
    "📏",
    "Irizpidea",
    "Iritzi bat edo erabaki bat oinarritzen dudan arrazoia edo araua."
   ],
   [
    "🧭",
    "Autonomia",
    "Norberak pentsatu eta erabakitzea, irizpide propioarekin, masari jarraitu beharrean."
   ],
   [
    "🕊️",
    "Karitate-printzipioa",
    "Bestearen jarrera bere bertsiorik sendoenean interpretatzea kritikatu aurretik."
   ],
   [
    "⚔️",
    "Gatazka",
    "Interesen edo ideien talka; elkarrizketaren eta negoziazioaren bidez konpon daiteke."
   ],
   [
    "🤲",
    "Negoziazioa",
    "Akordio bat bilatzea, non aldeek zerbait amore ematen duten zerbait irabazteko."
   ]
  ]
 },
 "ipc-falacias": {
  ...
  "cards": [
   [
    "🙅",
    "Ad hominem",
    "Pertsonari erasotzea haren argudioari beharrean: «Zer esango duzu zuk, egunero berandu iristen zarena?»."
   ],
   [
    "🥊",
    "Lastozko gizona",
    "Besteak dioena desitxuratzea, errazago eraisteko moduko bertsio bat gezurtatzeko."
   ],
   [
    "🚪",
    "Dilema faltsua",
    "Bi aukera baino ez aurkeztea gehiago daudenean: «Edo nirekin zaude edo nire aurka»."
   ],
   [
    "👥",
    "Ad populum",
    "«Denek egiten dute, beraz, ona da». Askok egiteak ez du egia bihurtzen."
   ],
   [
    "🎓",
    "Autoritateari deia",
   ...
   [
    "🔗",
    "Kausa faltsua (post hoc)",
    "Zerbait ondoren gertatu bada, haren kausaz izan dela sinestea: «Galtzerdi hauekin gainditu nuen»."
   ],
   [
    "😱",
    "Beldurrari deia",
    "Konbentzitzea, inolako frogarik ematen ez den ondorio izugarriekin beldurtuz."
   ],
   [
    "😢",
    "Errukiari deia",
    "Arrazoiak eman beharrean, pena ematea."
   ],
   [
    "🎲",
    "Orokortze presakakoa",
    "Kasu gutxi batzuetatik arau orokor bat ateratzea: «Bi aldiz joan nintzen eta beti dago beteta»."
   ],
   [
    "⏳",
    "Tradizioari deia",
    "«Beti egin da horrela», horrek berak justifikatuko balu bezala."
   ]
  ]
 },
 "ipc-sesgos": {
  "name": "Pentsamendu kritikoa · Alborapen kognitiboak",
  "subject": "ipc",
  "cards": [
   [
    "🧲",
    "Berrespen-alborapena",
    "Dagoeneko pentsatzen dudana berresten duena soilik bilatzea eta sinestea, gainerakoa alde batera utzita."
   ],
   [
    "⚓",
    "Ainguraketa",
    "Epaitzean jasotako lehen datuari itsatsita geratzea (lehen prezioa, lehen zifra)."
   ],
   [
    "📺",
    "Eskuragarritasuna",
    "Zerbait probableagoa dela sinestea erraz gogoratzen dudalako soilik (albistegietan asko ateratzen delako)."
   ],
   [
    "🐑",
    "Arrastatzea (bandwagon efektua)",
    "Taldeak bezala pentsatzea edo iritzia ematea, kanpoan ez geratzeko."
   ],
   [
    "✨",
    "Halo-efektua",
    "Norbait gustuko badut edo erakargarria iruditzen bazait, haren ideia guztiak ontzat ematen ditut."
   ],
   [
    "⏰",
    "FOMO",
    "Zerbait galtzeko beldurra; bulkadaz erabakitzera bultzatzen du, atzean ez geratzeko."
   ],
   [
    "🔀",
 ...
 "ipc-publicidad": {
  "name": "Pentsamendu kritikoa · Publizitatea eta hedabideak",
  "subject": "ipc",
  "cards": [
   [
    "🌟",
    "Testigantza / influencer-a",
    "Ospetsu batek produktua gomendatzen du, hartaz fida zaitezen."
   ],
   [
    "👥",
    "Denek dute (bandwagon)",
    "«Batu zaitez dagoeneko erabiltzen duten milioika lagunei»."
   ],
   [
    "⏳",
    "Urritasuna eta presa",
    "«Gaur bakarrik», «azken aleak»: pentsatu gabe erabakitzera behartzen dute."
   ],
   [
    "🌈",
    "Publizitate aspirazionala",
    "Ez du produktua saltzen, agintzen duen bizitza zoriontsu eta miretsia baizik."
   ],
   [
    "😂",
    "Umorea eta emozioa",
    "Barre eginarazten dizu edo hunkiarazten zaitu, sentsazio hori markarekin lot dezazun."
   ],
   [
    "🎯",
    "Clickbait-a",
    "Ematen duena baino gehiago agintzen duen titular puztua, klik egin dezazun."
   ],
   [
    "✅",
    "Iturriak alderatzea",
    "Sinetsi edo partekatu aurretik: nork dio?, zer frogarekin?, besteek berresten al dute?"
   ],
   [
    "🧠",
  ...
  "items": [
   ...
   },
   {
    ...
    "o": [
     "Lastozko gizona.",
     "Dilema faltsua.",
     "Ad hominem (pertsonaren aurkako erasoa).",
     "Tradizioari deia."
    ],
    "a": 2,
   ...
   },
   {
    ...
    "a": 0,
    "fb": "Bi aukera baino ez ditu aurkezten gehiago daudenean: beste egun batean joatea, edo ezin joan eta lagun izaten jarraitzea."
   },
   {
    "q": "«Gehien jarraitzen dudan streamer-ak dio zereal hauek egun osorako energia ematen dutela. Berak esaten badu, egia da».",
    "o": [
     "Tradizioari deia.",
     "Kausa faltsua (post hoc).",
     "Ad hominem.",
   ...
   },
   {
    ...
    "a": 1,
    "fb": "Jantzi ondoren gainditu zuen, baina kausa ikastea izan zen (edo zortea), ez galtzerdiak."
   },
   {
    "q": "«Nire koadrilako denek marka horretako entzungailuak dituzte. Denek badituzte, onenak dira».",
    "o": [
     "Autoritateari deia.",
     "Tradizioari deia.",
     "Ad populum (gehiengoari deia).",
    ...
    "a": 2,
    "fb": "Askok izateak modan daudela baino ez du esaten, ez hobeto entzuten direla."
   },
   {
    "q": "Bere entrenatzaileari: «Titular jarri behar nauzu. Aste osoa triste daramat eta, jokatzen ez badut, aitak atsekabe izugarria hartuko du».",
    "o": [
     "Errukiari deia (ad misericordiam).",
     "Beldurrari deia.",
     "Ad hominem.",
     "Orokortze presakakoa."
    ],
    "a": 0,
    "fb": "Pena ematen du (tristura, aitaren atsekabea) kirol-arrazoiak eman beharrean."
   },
   {
    "q": "«Larunbateko errefortzuan izena eman behar duzu. Bestela, dena suspendituko duzu, errepikatu egingo duzu eta lagunik gabe geratuko zara».",
    "o": [
     "Errukiari deia.",
     "Beldurrari deia (ad metum).",
     "Kausa faltsua.",
     "Lastozko gizona."
    ],
    "a": 1,
    "fb": "Etorkizun izugarri batekin beldurtuz konbentzitzen du, inolako frogarik eman gabe."
   },
   {
    "q": "«Bi aldiz joan naiz kiroldegi berrira eta bietan beteta zegoen. Beti dago beteta; ez du merezi joatea».",
    "o": [
     "Kausa faltsua (post hoc).",
     "Ad populum.",
     "Tradizioari deia.",
    ...
    "a": 3,
    "fb": "Bi bisitak ez dira nahikoa «beti dago beteta» esateko."
   },
   {
    "q": "«Nik igeri egiten ikasi nuen uretara flotagailurik gabe botata, eta aita ere bai. Beti horrela ikasi da, beraz, zuk ere horrela ikasiko duzu».",
    "o": [
     "Tradizioari deia (ad antiquitatem).",
     "Autoritateari deia.",
     "Dilema faltsua.",
     "Ad hominem."
    ],
    "a": 0,
    "fb": "«Beti horrela egin da» esateak ez du frogatzen modurik onena edo seguruena denik."
   }
  ]
 },
 "ipc-sesgos-q": {
  ...
  "items": [
   {
    "q": "Zer da alborapen kognitibo bat?",
    "o": [
     "Froga sendoak dituen argudio bat.",
     "Nola pentsatzen dugun okertzen duen buru-bidezidor bat, askotan konturatu gabe.",
     "Nahita esandako gezur bat.",
     "Ondo oinarritutako iritzi bat."
    ],
    "a": 1,
   ...
   },
   {
    ...
    "a": 0,
    "fb": "Berrespen-alborapena: dagoeneko sinesten duguna berresten duena soilik bilatzea."
   },
   {
    "q": "Denda batean, ikusten duzun lehen prezioak (200 €) 120 € merke iruditzea eragiten dizu. Zein alborapenek jarduten du?",
    "o": [
     "Eskuragarritasuna.",
     "Ainguraketa.",
     "Arrastatzea.",
    ...
    "a": 1,
    "fb": "Ainguraketa: lehen datuak («aingura») ondorengo judizioak baldintzatzen ditu."
   },
   {
    "q": "Hegazkin-istripuen albiste asko ikusi ondoren, hegan egitea oso arriskutsua dela sinesten duzu, datuek kontrakoa esan arren. Zein alborapen da?",
    "o": [
     "Halo-efektua.",
    ...
    "a": 1,
    "fb": "Eskuragarritasuna: erraz gogoratzen duguna dena baino probableagoa iruditzen zaigu."
   },
   {
    "q": "Iritzia aldatzen duzu zure talde osoak bestela pentsatzen duelako soilik eta kanpoan geratu nahi ez duzulako. Zein alborapen da?",
    "o": [
     "Arrastatzea (bandwagon efektua).",
     "Ainguraketa.",
     "Halo-efektua.",
    ...
    "a": 0,
    "fb": "Arrastatzea: gehiengoari jarraitzea taldetik kanpo ez geratzeko."
   },
   {
    "q": "Neska hori oso gustuko duzunez, haren ideia guztiak ontzat ematen dituzu aztertu gabe. Zein alborapen da?",
    "o": [
     "FOMO.",
     "Halo-efektua.",
     "Eskuragarritasuna.",
    ...
    "a": 1,
    "fb": "Halo-efektua: inpresio positibo batek (sinpatia, erakargarritasuna) gainerako guztia kutsatzen du."
   },
   {
    "q": "Zerbait presaka erosten duzu «denak doazelako eta galdu nahi ez dudalako». Zerk jarduten du?",
    "o": [
     "FOMO (zerbait galtzeko beldurra).",
     "Berrespen-alborapena.",
     "Karitate-printzipioa.",
     "Ainguraketa."
    ],
   ...
   },
   {
    ...
    "o": [
     "Inpresio positibo batek gainerako guztiari buruzko judizioa kutsatzen duela.",
     "Lehen datuak erabakia ainguratzen duela.",
     "Gehiengoari jarraitzen diogula.",
     "Sinesten dugunean baieztatzen gaituela."
    ],
    "a": 0,
    "fb": "Norbait gustuko badut, bere ideiak ontzat ematen ditut."
   },
   {
    "q": "Nola babesten da bat alborapenetatik?",
    "o": [
     "Gure ideiak gezurtatzen dituen informazioa bilatuz eta presaka hartutako erabakiez mesfidatuz.",
     "Informazio oro saihestuz.",
     "Gehiengoari jarraituz.",
     "Egiaztatu gabe birbidaliz."
    ],
    "a": 0,
    "fb": "Alborapenak zaintzea gu gezurtatzen gaituena bilatzea da."
   }
  ]
 },
 "ipc-medios-q": {
  ...
  "items": [
   {
    "q": "Iragarki batean zure influencer gogokoena agertzen da produktua erabiltzen. Zer teknika da?",
    "o": [
     "Urritasuna.",
     "Pertsona ezagun baten testigantza.",
     "Umorea.",
     "Datu zientifikoak."
    ],
    "a": 1,
    "fb": "Testigantza: pertsona ezagun batek bere irudia uzten du, zuk produktuan konfiantza izan dezazun."
   },
   {
    "q": "«Gaur bakarrik! Azken unitateak!» Zer publizitate-teknika da?",
    "o": [
     "Urritasuna eta presa.",
     "Publizitate aspirazionala.",
     "Testigantza.",
    ...
    "a": 0,
    "fb": "Urritasuna eta presa: pentsatu gabe eros dezazun presionatzen zaituzte."
   },
   {
    "q": "Iragarki batek ez du produktua erakusten, hark agintzen duen bizitza zoriontsu eta miretsi bat baizik. Nola deitzen da?",
    "o": [
     "Clickbaita.",
     "Publizitate aspirazionala.",
     "Arraste-efektua (bandwagon).",
     "Iturriak kontrastatzea."
    ],
    "a": 1,
    "fb": "Publizitate aspirazionala: bizimodu bat saltzen du, ez produktua bera."
   },
   {
    "q": "Titular puztu batek artikuluak ematen duena baino askoz gehiago agintzen du, klik egin dezazun. Hori zera da…",
    "o": [
     "alfabetatze mediatikoa.",
     "clickbaita.",
     "argudio bat.",
    ...
    "a": 1,
    "fb": "Clickbaita: klik-amua, titular puztu edo engainagarrien bidez."
   },
   {
    "q": "Mezu biral kezkagarri bat iristen zaizu. Zer da zentzuzkoena, sinetsi edo birbidali aurretik?",
    "o": [
     "Azkar birbidaltzea, badaezpada.",
     "Iturria kontrastatzea: nork dioen, zer frogarekin eta beste batzuek berresten duten.",
     "Sinestea, lagun batek bidali duelako.",
     "Begiratu gabe ezabatzea."
    ],
    "a": 1,
    "fb": "Iturriak kontrastatu: nork dio?, zer froga daude?, hedabide fidagarriek berresten dute?"
   },
   {
    "q": "«Batu zaitez dagoeneko erabiltzen duten milioika pertsonei.» Publizitatean, hori zera da…",
    "o": [
     "denek dutela argudiatzea (arraste-efektua, bandwagon).",
     "urritasuna.",
     "umorea.",
     "datu tekniko bat."
    ],
    "a": 0,
    "fb": "Bandwagon (arraste-efektua): «denek erabiltzen dute», zuk ere erabil dezazun arrazoi gisa."
   },
   {
    "q": "Hedabide batean informazioa, iritzia eta publizitatea bereizten jakiteari zera deitzen zaio…",
    "o": [
     "clickbaita.",
     "alfabetatze mediatikoa.",
     "post-egia.",
    ...
    "a": 1,
    "fb": "Alfabetatze mediatikoa: hedabideak modu kritikoan irakurtzea."
   },
   {
    "q": "Zergatik erabiltzen ditu publizitateak hainbeste umorea eta emozioa?",
    "o": [
     "Produktuari buruzko datu objektiboak ematen dituelako.",
     "Emozio atsegin hori markarekin lotu eta marka gogora dezazun.",
     "Legeak behartzen duelako.",
     "Osagaien berri emateko."
    ],
    "a": 1,
    "fb": "Emozio positiboa markarekin lotzen da eta hura gogoratzen laguntzen du, arrazoirik eman beharrik gabe."
   },
   {
    "q": "Zer da alfabetatze mediatikoa?",
    "o": [
     "Hedabideak kritikoki irakurtzea, informazioa, iritzia eta publizitatea bereiziz.",
     "Prentsak dioen guztia sinestea.",
     "Hedabideak saihestea.",
     "Publizitatea soilik kontsumitzea."
    ],
    "a": 0,
    "fb": "Hedabideak modu kritikoan irakurtzen jakitea da alfabetatze mediatikoa."
   },
   {
    "q": "Mezu biral bat partekatzeko zorian zaude. Zer egiten duzu (pentsamendu kritikoa)?",
    "o": [
     "Iturria eta frogak egiaztatzea partekatu aurretik.",
     "Berehala birbidaltzea.",
     "Sinestea, lagun batek bidali duelako.",
     "Begiratu gabe ezkutatzea."
    ],
    "a": 0,
